...
Try {
	...
	[string]$appVendor = 'KeyMetrics'
	[string]$appName = 'Permissions Reporter'
	[string]$appVersion = '3.8.437'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	$CloseApps = "Permissions Reporter"
	...
	#$RemoveAppNamesMSI = @("")
	$RemoveAppNamesEXE = @("Permissions Reporter")
	...
	# Application uninstall parameters.
	$64bitAppUninstallParam = "/x {C57C5086-2182-4080-8CDC-23AC252DBA94} /qn"
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Remove-Item -Path "${Env:PUBLIC}\Desktop\Permissions Reporter.lnk"
